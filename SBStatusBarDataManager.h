...
@interface SBStatusBarDataManager : _ABAddressBookCopyLocalizedLabel
{
    CDAnonymousStruct1 _data;
    int _actions;
...
- (BOOL)_getServiceImageNames:(id [2])fp8 directory:(id *)fp12 forOperator:(id)fp16 statusBarCarrierName:(id *)fp20;
...
- (void)_postData;
- (void)_dataChanged;
- (const CDAnonymousStruct1 *)currentData;
- (void)resetData;
- (void)setThermalColor:(int)fp8 sunlightMode:(BOOL)fp12;
...
- (BOOL)setStatusBarItem:(int)fp8 enabled:(BOOL)fp12;
- (void)endUpdateBlock;
